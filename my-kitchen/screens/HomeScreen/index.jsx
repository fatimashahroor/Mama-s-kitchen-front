    ...
    return (
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <View style={styles.container}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('EditDishes')}>
                ...
                <View style={styles.scrollView}>
                    <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
                        {days.map((day, index) => (
                            <TouchableOpacity style={styles.day} key={index} onPress={() => handleDayPress(day)}>
                ...
                <View>
                    ...
                    {filteredDishes.length > 0 ? filteredDishes.map((data)=> (
                        <TouchableOpacity key={data.id} onPress={() => navigation.navigate('Dish', {'dishId': data.id, 'cook': data.user_full_name})}>
